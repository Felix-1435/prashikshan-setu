...
import { ExternalLink, BookOpen, Clock, Award, Building2 } from "lucide-react";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-ink-mute mt-1 max-w-2xl">
          ...
          Complete quizzes to recalibrate recommendations live.
        </p>
      </div>
      ...
      <div className="space-y-3">
              ...
              <div className="flex gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-1.5 text-xs text-ink-mute">
                    ...
                    <span
                      className={`pill ${levelColor[r.level] || "bg-slate-100 text-slate-700"}`}
                    >
        ...
        {!loading && recs.length === 0 && (
          <div className="card p-8 text-center">
            ...
            <p className="text-ink-mute text-sm">No recommendations yet — complete a quiz or check gaps on Home.</p>
          </div>
        )}
      </div>
    </div>
